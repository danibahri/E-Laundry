...
## Langkah-langkah: Lalu jalankan di terminal di folder yang mau di download:

    Clone your project (git clone https://github.com/Wichtra/project-Login)
    Masuk ke direktori (cd project-login)
    code . Buka terminal di vscode
    composer install
    cp .env.example .env
    Buka .env trus cari DB_* sesuaikan sama database kalian (kalau port Db ga dimodifikasi langsung step selanjutnya)
